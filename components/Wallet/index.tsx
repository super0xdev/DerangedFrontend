...
export const Wallet = () => {
  ...
  if (!address) {
    return (
      <button className='p-2 bg-yellow-500 rounded-md' onClick={() => connectWallet("injected")}>
  ...
  return (
    <CopyToClipboard
      ...
      <button className="p-2 border-2 border-yellow-500 border-solid bg-gradient-to-t from-yellow-700 via-yellow-400 to-yellow-300">
